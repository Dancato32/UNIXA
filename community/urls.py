...
urlpatterns = [
    ...
    path('workspaces/<uuid:ws_id>/files/<uuid:file_id>/delete/', views.workspace_delete_file, name='workspace_delete_file'),
    path('workspaces/<uuid:ws_id>/tasks/', views.workspace_add_task, name='workspace_add_task'),
    path('workspaces/<uuid:ws_id>/tasks/list/', views.workspace_tasks_list, name='workspace_tasks_list'),
    ...
    path('workspaces/<uuid:ws_id>/tasks/<uuid:task_id>/log/', views.workspace_task_log, name='workspace_task_log'),
    path('workspaces/<uuid:ws_id>/tasks/<uuid:task_id>/activity/', views.workspace_task_activity, name='workspace_task_activity'),
    path('workspaces/<uuid:ws_id>/tasks/<uuid:task_id>/autopilot/', views.workspace_task_autopilot, name='workspace_task_autopilot'),
    path('workspaces/<uuid:ws_id>/tasks/<uuid:task_id>/navigator/', views.nexa_task_navigator, name='nexa_task_navigator'),
    path('workspaces/<uuid:ws_id>/assembly/', views.workspace_final_assembly, name='workspace_final_assembly'),
    path('workspaces/<uuid:ws_id>/peer/<str:peer_username>/', views.workspace_peer_chat, name='workspace_peer_chat'),
    path('workspaces/<uuid:ws_id>/peer/<str:peer_username>/contributions/', views.workspace_member_contributions, name='workspace_member_contributions'),
