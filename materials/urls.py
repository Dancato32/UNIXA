...
urlpatterns = [
    ...
    path('flashcards/<int:pk>/decks/', views.flashcards_decks, name='flashcards_decks'),
    path('flashcards/<int:pk>/decks/<int:deck_id>/', views.flashcards_load, name='flashcards_load'),
    path('flashcards/<int:pk>/decks/<int:deck_id>/delete/', views.flashcards_delete_deck, name='flashcards_delete_deck'),
